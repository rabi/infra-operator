...
// OpenStackNetworksSpec defines the desired state of OpenStackNetworks
type OpenStackNetworksSpec struct {
...
// OpenStackNetworksStatus defines the observed state of OpenStackNetworks
type OpenStackNetworksStatus struct {
...
// OpenStackNetworks type
type OpenStackNetworks struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   OpenStackNetworksSpec   `json:"spec,omitempty"`
	Status OpenStackNetworksStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// OpenStackNetworksList contains a list of OpenStackNetworks
type OpenStackNetworksList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OpenStackNetworks `json:"items"`
}

func init() {
	SchemeBuilder.Register(&OpenStackNetworks{}, &OpenStackNetworksList{})
}
